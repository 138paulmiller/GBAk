...
int main( ) { 
    *display_control = MODE0 | BG0 | BG1 | SPRITE_ENABLE | SPRITE_MAP_1D;
	...
	struct sprite_img sprite_img0 = (struct sprite_img) {koopa_data, koopa_palette, koopa_width, koopa_height, 2}; //2 frames
	...
	//init sprites
	sprite_clear(); //clear memory
	//sprite_load_img(sprite_img0);
	sprite0 = sprite_make(SCREEN_WIDTH/2, SCREEN_HEIGHT/2, SPRITE_16_8, 0, 0, 0, 0);
